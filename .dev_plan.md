...
- [ ] **Step 9A-1a：新增 `book_blueprints` 最小表**
...
- [ ] **Step 9A-2a：章节规划器 deterministic 节点**
  - 输入：locked blueprint。
...
- [ ] **Step 9A-4a：新增 `book_runs` 最小表与 API**
...
- [ ] **Step 9A-4b：BookLoop 顺序驱动 3 章 NovelLoop**
...
- [ ] **Step 9C-1a：Scene Packet 自动召回 memory**
