...
> **给执行代理的要求：** 必须使用 `superpowers:subagent-driven-development`（推荐）或 `superpowers:executing-plans` 按任务执行。所有步骤使用复选框跟踪。所有验证必须在本地完成，并写入 `D:\StoryForge\1-renovel-ai-ai-rag-tavern\.codex\verification-report.md`。
...
- `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\runner.py`
  - 定义 `NovelSkillRun`、`NovelSkillRunner`、引用摘要构造与端口包装结果。
- `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\tests\test_novel_skill_runner.py`
  - 覆盖 runner 成功、失败、引用化记录、预算字段、禁止完整正文入记录。
- `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\tests\test_novel_loop_skill_runner_integration.py`
  - 覆盖通过 runner 执行后 `run_single_chapter_loop()` 对外结果等价。
- `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\genre_mystery\clue_fairness_judge\SKILL.md`
  - 悬疑线索公平性题材技能定义。
- `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\genre_xuanhuan\power_scale_guard\SKILL.md`
  - 玄幻战力等级守卫题材技能定义。
- `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\genre_romance\relationship_arc_judge\SKILL.md`
  - 言情关系弧评审题材技能定义。
- `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\tests\test_genre_skill_registry.py`
...
- `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\api\tests\test_book_runs.py`
...
- `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\web\tests\...`
...
- Read: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\definitions.py`
- Read: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\audit.py`
...
1. 停止阶段二实现。
2. 在 `D:\StoryForge\1-renovel-ai-ai-rag-tavern\.codex\operations-log.md` 记录缺失文件或失败测试。
...
**Files:**
- Create: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\runner.py`
- Create: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\tests\test_novel_skill_runner.py`
- Reference: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\definitions.py`

- [ ] **Step 1.1：写失败测试：NovelSkillRun 只保存引用化字段**
...
- [ ] **Step 1.5：新增 runner 查 registry 测试**
...
- [ ] **Step 1.6：实现 NovelSkillRunner.definition_for() 并验证**
...
**Files:**
- Modify: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\runner.py`
- Modify: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\tests\test_novel_skill_runner.py`
- Reference: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\orchestrators\novel_loop.py`

- [ ] **Step 2.1：写失败测试：generate 包装记录 model_run_id**
...
- [ ] **Step 2.2：写失败测试：judge/repair/approve/memory_extract 顺序记录**
...
**Files:**
- Modify: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\orchestrators\novel_loop.py`
- Create: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\tests\test_novel_loop_skill_runner_integration.py`
- Reference: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\tests\test_novel_loop_single_chapter.py`

- [ ] **Step 3.1：写失败测试：approved 路径结果等价且记录技能链**
...
- [ ] **Step 3.2：写失败测试：repair 路径记录 generate/judge/repair/judge/approve**

断言首次 judge 返回 `repair` 后进入 repair，再次 judge pass 后 approve；最终 `NovelLoopResult.status == "approved"`。

- [ ] **Step 3.3：写失败测试：高危静态质量门不进入 judge**
...
- [ ] **Step 3.6：运行 NovelLoop 与 BookLoop 回归**
...
**Files:**
- Modify: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\audit.py`
- Modify: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\tests\test_skill_audit_summary.py`

- [ ] **Step 4.1：写失败测试：progress 中带 skill_runs 时优先使用真实记录**
...
- [ ] **Step 4.2：写失败测试：无 skill_runs 时保持阶段一派生行为**
...
**Files:**
- Modify: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\api\app\domains\book_runs\schemas.py`
- Modify: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\api\app\domains\book_runs\service.py`
- Modify or Create: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\api\tests\test_book_runs.py`

- [ ] **Step 5.1：定位 audit_report 测试与生成函数**
...
- [ ] **Step 5.2：写失败测试：audit_report 包含 skill_chain**
...
- [ ] **Step 5.3：写失败测试：旧 progress 无 skill_chain 时输出空摘要而不报错**
...
- [ ] **Step 5.5：实现 schema/service 追加逻辑**
...
**Files:**
- Modify: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\web\app\book-runs\[id]\audit\...`
- Modify or Create: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\web\tests\...`
...
- [ ] **Step 6.2：写失败测试：有 skill_chain 时渲染技能链**
...
- [ ] **Step 6.3：写失败测试：无 skill_chain 时显示空状态**
...
**Files:**
- Create: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\genre_mystery\clue_fairness_judge\SKILL.md`
- Create: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\genre_xuanhuan\power_scale_guard\SKILL.md`
- Create: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\genre_romance\relationship_arc_judge\SKILL.md`
- Modify: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\storyforge_workflow\skills\definitions.py`
- Create: `D:\StoryForge\1-renovel-ai-ai-rag-tavern\apps\workflow\tests\test_genre_skill_registry.py`

- [ ] **Step 7.1：写失败测试：默认 registry 不包含题材技能**
...
- [ ] **Step 7.2：写失败测试：显式选择 mystery 加载线索公平性技能**
...
- [ ] 第一阶段基线文件与测试在当前工作区通过。
- [ ] `NovelSkillRun` 与 `NovelSkillRunner` 能记录引用化技能运行记录。
- [ ] `run_single_chapter_loop()` 接入 runner 后保持 `NovelLoopResult` 对外契约等价。
- [ ] `derive_skill_chain_summary()` 能消费真实 `skill_runs`，也兼容阶段一 progress 派生。
- [ ] `audit_report.json` 追加 `skill_chain`，且旧数据可空退化。
- [ ] Web 审计页能展示技能链，无数据时显示明确空状态。
- [ ] 题材技能包只能显式选择，默认 BookRun 不加载题材扩展。
- [ ] `apps/workflow` 全量 pytest 通过。
- [ ] `apps/api` 全量 pytest 通过。
- [ ] `pnpm run test:web` 通过。
- [ ] `pnpm test` 通过。
- [ ] `pnpm verify` 通过。
- [ ] `.codex/verification-report.md` 综合评分 ≥ 90，建议为“通过”。
...
- **执行建议：** 下一步从 Task 0 开始，确认当前工作区第一阶段产物存在后，再进入 Task 1。