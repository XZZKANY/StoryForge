# Claude-like Home Visual Parity Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** 将实际 Next 首页 `http://127.0.0.1:3000/?intent=111` 调整为已确认静态预览的 Claude-like 深色首页，同时保持 StoryForge 的 Blueprint、BookRun、Studio、Retrieval、Artifacts、Runs 业务入口。
...
- [ ] **Step 3: 将 `HomeSidebar` 改为 Claude-like 侧边栏**
