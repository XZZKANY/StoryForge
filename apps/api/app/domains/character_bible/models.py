...
class CharacterBibleEntry(IdMixin, TimestampMixin, VersionMixin, Base):
    ...
    lineage_key: Mapped[str] = mapped_column(String(80), index=True, nullable=False, default=lambda: str(uuid4()))
    ...
    sync_status: Mapped[str] = mapped_column(String(50), nullable=False, default="pending", server_default="pending")
    memory_atom_id: Mapped[str | None] = mapped_column(String(80))
