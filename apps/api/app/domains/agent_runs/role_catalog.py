...
_AGENT_ROLE_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "read_only": False,
        "default_permission_profile": DEFAULT_PERMISSION_PROFILE,
        "allowed_tools": ["context.load", "file.review", "file.revise", "judge.run", "judge.repair"],
    ...
    },
    {
        ...
        "read_only": True,
        "default_permission_profile": "read",
        "allowed_tools": ["context.load", "fs.list", "fs.read", "fs.search", "project.consistency", "project.prose_check", "project.collapse_check", "project.entity_budget_check", "project.canon", "project.canon_delta", "project.hooks_delta", "mcp.project.search", "mcp.context.inspect"],
        "output_artifacts": ["review_report"],
        "can_be_mentioned": True,
    },
    {
