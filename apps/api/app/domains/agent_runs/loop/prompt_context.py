...
_SYSTEM_PROMPT = (
    ...
    "每轮开头的「连载计划」块给出下一章写什么；写完一章后用 project_plan_update 传 "
    "{ordinal, status:'done'} 把它标掉，否则下一章不会前移、作者说「继续」时你会重写同一章。"
    "作者给出大纲时用同一把工具一次建起多章计划。它只写 .storyforge/serial-plan.json，不写正文。"
