...
根据 judge 报告修复草稿，并保留修复补丁引用供后续审计。
...
- 页面引用：无
- API 路径：无
- Workflow 节点：`NovelLoopPorts.repair_scene`
- 事实源：`apps/workflow/storyforge_workflow/orchestrators/novel_loop.py:82`, `apps/workflow/storyforge_workflow/orchestrators/novel_loop.py:105`
