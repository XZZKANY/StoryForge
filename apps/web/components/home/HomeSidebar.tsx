  ...
  return (
    ...
    >
      <div className="flex h-9 items-center justify-between">
        <Link
          href="/"
          className="font-serif text-2xl font-semibold tracking-tight text-[#f4eadb] no-underline"
        >
          StoryForge
        </Link>
      ...
      <section aria-labelledby="home-recent-title" className="mt-7 min-h-0">
        ...
        <p className="sr-only">{homeRecentEmpty}</p>
        <ul className="!m-0 mt-3 !grid !grid-cols-1 !gap-3.5 !p-0 text-sm text-[#d7cec1]">
      ...
      <section
        className="mt-auto flex items-center gap-3 border-t border-[#3b3a37] pt-3"
        aria-label="工作区状态"
      >
