...
import { BookRunStatusPanel, exportAuditReportRequest, exportMarkdownRequest } from '../app/book-runs/api';
  ...
  const html = renderToStaticMarkup(
    React.createElement(BookRunStatusPanel, {
      bookRun: {
        ...
        checkpoint: [{ chapter_index: 3, model_run_id: 31, judge_report_id: 32, approved_scene_id: 33 }],
        token_budget: 1200,
        tokens_used: 840,
        time_budget_sec: 300,
