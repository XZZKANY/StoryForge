...
export async function readStudioChapterGoal(target: StudioTarget | undefined): Promise<StudioChapterGoalState> {
  if (!target) {
...
export async function readStudioScenePacket(target: StudioTarget | undefined): Promise<StudioScenePacketState> {
  if (!target) {
...
export async function readStudioJudgeReview(scenePacketState: StudioScenePacketState): Promise<StudioJudgeReviewState> {
...
export async function readStudioRepairPatches(scenePacketState: StudioScenePacketState): Promise<StudioRepairPatchState> {
  if (scenePacketState.status !== "ready") {
...
export async function readStudioApprovalSummaryByQuery(key: "scene_packet_id" | "repair_patch_id", value: number): Promise<StudioApprovalSummaryState> {
...
export async function readStudioRecoverySummary(scenePacketState: StudioScenePacketState): Promise<StudioRecoverySummaryState> {
  if (scenePacketState.status !== "ready") {
