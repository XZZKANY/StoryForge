...
const runtimeModules = [
  ...
  { src: 'components/ide/commands/command-client.ts', dst: 'components/ide/commands/command-client.mjs' },
  { src: 'components/ide/commands/registry.ts', dst: 'components/ide/commands/registry.mjs' },
  { src: 'components/ide/commands/registerBuiltinCommands.ts', dst: 'components/ide/commands/registerBuiltinCommands.mjs' },
  ...
  { src: 'components/ide/personalization/preferences.ts', dst: 'components/ide/personalization/preferences.mjs' },
  { src: 'components/ide/personalization/PersonalizationPanel.tsx', dst: 'components/ide/personalization/PersonalizationPanel.mjs' },
  ...
  { src: 'components/ide/panels/ProblemsPanel.tsx', dst: 'components/ide/panels/ProblemsPanel.mjs' },
  { src: 'components/ide/views/DiffViewer.tsx', dst: 'components/ide/views/DiffViewer.mjs' },
  { src: 'components/ide/views/ContextInspector.tsx', dst: 'components/ide/views/ContextInspector.mjs' },
  { src: 'components/ide/views/StoryMemoryExplorer.tsx', dst: 'components/ide/views/StoryMemoryExplorer.mjs' },
  { src: 'components/ide/views/BookRunPanel.tsx', dst: 'components/ide/views/BookRunPanel.mjs' },
  { src: 'components/ide/views/ArtifactViewer.tsx', dst: 'components/ide/views/ArtifactViewer.mjs' },
  { src: 'components/ide/editors/ChapterEditor.tsx', dst: 'components/ide/editors/ChapterEditor.mjs' },
  { src: 'components/ide/editors/extensions/judgeIssueDecorations.ts', dst: 'components/ide/editors/extensions/judgeIssueDecorations.mjs' },
...
const importRewrites = [
  ...
  ['../components/ide/commands/registerBuiltinCommands', '../components/ide/commands/registerBuiltinCommands.mjs'],
  ...
  ['../components/ide/personalization/preferences', '../components/ide/personalization/preferences.mjs'],
  ['../components/ide/personalization/PersonalizationPanel', '../components/ide/personalization/PersonalizationPanel.mjs'],
  ...
  ['../components/ide/views/StoryMemoryExplorer', '../components/ide/views/StoryMemoryExplorer.mjs'],
  ...
  ['../components/ide/editors/extensions/judgeIssueDecorations', '../components/ide/editors/extensions/judgeIssueDecorations.mjs'],
