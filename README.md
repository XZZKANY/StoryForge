...
当前仓库已完成 Phase 1 到 Phase 4 的工程闭环，后续工作以真实 AI/RAG 接入、产品工作台可用化和发布治理为主。详细路线见 `docs/superpowers/plans/2026-05-17-storyforge-master-replan.md`。
...
| Phase 5 | 真实 AI/RAG 接入 | provider、embedding、reranker、ModelRun、Scene Packet 真实证据链 |
| Phase 6 | 产品工作台可用化 | Studio、Retrieval、Runs、Artifacts、Evaluations 连续操作体验 |
